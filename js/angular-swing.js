...
Card.config = function (config) {
    ...
    config.minThrowOutDistance = config.minThrowOutDistance ? config.minThrowOutDistance : 150;
    config.maxThrowOutDistance = config.maxThrowOutDistance ? config.maxThrowOutDistance : 250;
